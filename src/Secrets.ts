...
export default class Secrets {
  ...
  public get accessToken() : string {
    if(!this._accessToken) {
      throw new Error("Initialize method must be called before any properties can be accessed.")
    }
  ...
  public async initialize():Promise<Secrets> {
    ...
    if(!this.accessToken) {
      throw new Error("secrets.json not properly configured.  Please review the project README.md.");
    }
    return this;
  }
